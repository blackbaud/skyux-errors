...
import { SkyErrorModalService } from 'projects/errors/src/public-api';
...
export class ErrorVisualComponent {
  ...
  public openModalWithLongDescription() {
    const config: any = {
      ...
      errorDescription:
        "Try to refresh this page, or come back later. And now I'm going to make this really long so that it will go to the next line.",
